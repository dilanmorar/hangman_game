...
def main():
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "bodywash", "clothing",
                 ...
                 "purple", "orange", "family", "twelve", "silver",
                 "donate", "abruptly", "absurd", "avenue", "awkward",
                 "bandwagon", "blizzard", "buzzard", "croquet", "espionage",
                 "fixable", "fluffiness", "funny", "galvanize", "galaxy",
                 "ivy", "jackpot", "jigsaw", "jiujitsu", "joking",
                 "kayak", "khaki", "luxury", "kiosk", "mystify",
                 "oxygen", "puppy", "queue", "rhubarb", "rhthym",
                 "strength", "swivel", "vodka", "whiskey", "wizard",
                 "zipper", "xylophone", "potato", "hedge", "robotic",
                 "lazy", "running", "haloumi", "formula", "business",
                 "strawberry", "grass", "leaves", "cloud", "trucker",
                 "laptop", "mobile", "tape", "picture", "synonym"
                 ]
